...
function custno(code)
{
    ...
    var url = "search_sub_category_data.php";
...
function passcusresult_quot()
{
    ...
    if (xmlHttp.readyState == 4 || xmlHttp.readyState == "complete")
    {
        ...
        opener.document.getElementById('Sub_Category_ID').value = XMLAddress1[0].childNodes[0].nodeValue;
        ...
        opener.document.getElementById('Sub_Category').value = XMLAddress1[0].childNodes[0].nodeValue;
