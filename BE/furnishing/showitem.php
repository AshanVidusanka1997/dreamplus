            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item active">
                        <a style="color: white;" class="nav-link" href="store.php">Home <span class="sr-only">(current)</span></a>
                    </li>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <?php
                    $subcatid = $_GET['id'];
                    $sql = "select * from item where Item_ID = $subcatid";
                    foreach ($conn->query($sql) as $row) {
                        echo "<div class='row'>";
                        ...
                        <div class=\"caption\">
                            <h2><u>" . $row['Name'] . "</u></h2>
                            <p style=\"float: right;\"> Rs " . number_format($row['amount'],2) . "</p><br>
                            <p style=\"font-size: 18px;margin: 0px;\"> Model : " . $row['Model'] . "</p>
                            <p style=\"font-size: 18px\"> Size : " . $row['Size'] . "</p>";
                                
                        if ($row['Description']!="") {
                             echo "  <p>DES : " . $row['Description'] . "</p>";
                        }
                          

                        if ($row['Features_Specifications']!="") {
                             echo "<p>SEP : " . $row['Features_Specifications'] . "</p>";
                        }
