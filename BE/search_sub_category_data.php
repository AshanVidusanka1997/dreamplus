...
if ($_GET["Command"] == "pass_quot") {
    ...
    $sql = "Select * from sub_category where Sub_Category_ID ='" . $cuscode . "'";
    ...
    if ($row = $sql->fetch()) {
        ...
        $ResponseXML .= "<id><![CDATA[" . $row['Sub_Category_ID'] . "]]></id>";
           $ResponseXML .= "<str_customername1><![CDATA[" . $row['Category_ID'] . "]]></str_customername1>";
